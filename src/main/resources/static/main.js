...
_LandingPageComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LandingPageComponent, selectors: [["app-landing-page"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 5, vars: 0, consts: [["routerLink", "books/create"]], template: function LandingPageComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LandingPageComponent, { className: "LandingPageComponent", filePath: "src\\app\\landing-page\\landing-page.component.ts", lineNumber: 12 });
})();

// src/app/app.routes.ts
var routes = [
  { path: "", component: LandingPageComponent, canActivate: [AuthGuard] },
  { path: "books", loadChildren: () => import("./chunk-K6DSXQSQ.js").then((mod) => mod.bookManagementRoutes) }
];
...
var _LoginComponent = class _LoginComponent {
  ...
  onSubmitForm() {
    this.authService.login(this.loginForm.value).pipe(tap((login) => {
      if (login.allowed) {
        this.authService.setUserConnected(true);
        this.router.navigateByUrl("/");
      } else {
        this.errorMessage = "Connexion non autoris\xE9e";
      }
    })).subscribe();
  }
};
...
_LoginComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginComponent, selectors: [["app-login"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 16, vars: 3, consts: [[1, "form-card"], [3, "formGroup"], [4, "ngIf"], [1, "form-group"], ["for", "pseudo"], ["id", "pseudo", "type", "text", "formControlName", "pseudo"], ["for", "password"], ["id", "password", "type", "text", "formControlName", "password"], [1, "action-butttons"], ["type", "submit", 3, "disabled", "click"]], template: function LoginComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "h1");
    \u0275\u0275text(1, "Connexion requise");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "div", 0)(3, "form", 1);
    \u0275\u0275template(4, LoginComponent_p_4_Template, 2, 1, "p", 2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LoginComponent, { className: "LoginComponent", filePath: "src\\app\\auth\\component\\login\\login.component.ts", lineNumber: 15 });
})();
